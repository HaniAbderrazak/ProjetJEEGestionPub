...
<div class="container-fluid">
 ...
 <div class="row">
                <div class="col-12 col-md-12 col-xl-10 col-left">
                 <div class="card mb-4">
                        <div class="card-body">
                            <h3 class="mb-4">Update Publication</h3>

                            <form action="ModifierPublication" method="post"   enctype="multipart/form-data">
                               
                               <input type="hidden" name="id" value="${pub.id}"  class="form-control "> 
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group ">
                                        ...
                                        <c:forEach var="c" items="${cat}" > 
                                 			<option value="${c.id}"<c:if test="${c.id==pub.categorie.id}">selected</c:if>> ${c.nom}</option>
                                 		</c:forEach>
                                 		</select>
                                    </div>
